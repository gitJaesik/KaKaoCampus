...
public class SpringTimeBeatActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spring_time_beat);
    ...
    class LoadAllData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SpringTimeBeatActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    //ListAdapter adapter = new SimpleAdapter( SpringTimeBeatActivity.this, dataList, R.layout.list_item, new String[] { TAG_USERNAME, TAG_USERCONTENTS}, new int[] { R.id.username, R.id.usercontents });
                    ListAdapter adapter = new SimpleAdapter(SpringTimeBeatActivity.this, dataList, R.layout.listview1_item,
